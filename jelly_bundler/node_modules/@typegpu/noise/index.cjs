...
const randomGeneratorShell = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([], d__namespace.f32), "randomGeneratorShell"));
const BPETER = (() => {
  const seed = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.privateVar(d__namespace.vec2f), "seed"));
  return {
    seed: ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.f32])((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((value) => {
      seed.value = d__namespace.vec2f(value, 0);
    }), {
              v: 1,
              name: undefined,
              ast: {"params":[{"type":"i","name":"value"}],"body":[0,[[2,[7,"seed","value"],"=",[6,[7,"d","vec2f"],["value",[5,"0"]]]]]],"externalNames":["seed","d"]},
              externals: () => ({seed, d: d__namespace}),
            }) && $.f)({}))), "seed")),
    seed2: ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec2f])((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((value) => {
      seed.value = d__namespace.vec2f(value);
    }), {
              v: 1,
              name: undefined,
    ...
    seed3: ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3f])((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((value) => {
      seed.value = std.add(value.xy, d__namespace.vec2f(value.z));
    }), {
              v: 1,
              name: undefined,
              ast: {"params":[{"type":"i","name":"value"}],"body":[0,[[2,[7,"seed","value"],"=",[6,"add",[[7,"value","xy"],[6,[7,"d","vec2f"],[[7,"value","z"]]]]]]]],"externalNames":["seed","add","d"]},
              externals: () => ({seed, add: std.add, d: d__namespace}),
            }) && $.f)({}))), "seed3")),
    seed4: ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec4f])((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((value) => {
      seed.value = std.add(value.xy, value.zw);
    }), {
              v: 1,
              name: undefined,
              ast: {"params":[{"type":"i","name":"value"}],"body":[0,[[2,[7,"seed","value"],"=",[6,"add",[[7,"value","xy"],[7,"value","zw"]]]]]],"externalNames":["seed","add"]},
              externals: () => ({seed, add: std.add}),
            }) && $.f)({}))), "seed4")),
    sample: randomGeneratorShell((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = (() => {
      "use gpu";
      const a = std.dot(seed.value, d__namespace.vec2f(23.14077926, 232.61690225));
      const b = std.dot(seed.value, d__namespace.vec2f(54.47856553, 345.84153136));
      seed.value.x = std.fract(std.cos(a) * 136.8168);
      seed.value.y = std.fract(std.cos(b) * 534.7645);
      return seed.value.y;
    }), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({dot: std.dot, seed, d: d__namespace, fract: std.fract, cos: std.cos}),
            }) && $.f)({})))
  };
})();
const DefaultGenerator = BPETER;
const randomGeneratorSlot = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.slot(
  DefaultGenerator
), "randomGeneratorSlot"));

const TWO_PI = Math.PI * 2;
const EPS = 1e-7;
const randSeed = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.f32])((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((seed) => {
...
const randSeed2 = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec2f])((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((seed) => {
...
const randSeed3 = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3f])((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((seed) => {
...
const randSeed4 = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec4f])((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((seed) => {
...
const randFloat01 = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([], d__namespace.f32)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = (() => randomGeneratorSlot.value.sample()), {
              v: 1,
              name: undefined,
              ast: {"params":[],"body":[0,[[10,[6,[7,[7,"randomGeneratorSlot","value"],"sample"],[]]]]],"externalNames":["randomGeneratorSlot"]},
              externals: () => ({randomGeneratorSlot}),
            }) && $.f)({}))), "randFloat01"));
const randInUnitCube = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([], d__namespace.vec3f)(
  (($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = (() => d__namespace.vec3f(
    ...
    randomGeneratorSlot.value.sample()
              ...
              externals: () => ({d: d__namespace, randomGeneratorSlot}),
            }) && $.f)({}))
), "randInUnitCube"));
const randOnUnitCube = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([], d__namespace.vec3f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = (() => {
  const face = d__namespace.u32(randomGeneratorSlot.value.sample() * 6);
  const axis = face % 3;
  const result = d__namespace.vec3f();
  result[axis] = d__namespace.f32(std.select(0, 1, face > 2));
  ...
  return result;
              ...
              externals: () => ({d: d__namespace, randomGeneratorSlot, select: std.select}),
            }) && $.f)({}))), "randOnUnitCube"));
const randInUnitCircle = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([], d__namespace.vec2f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = (() => {
  const radius = std.sqrt(randomGeneratorSlot.value.sample());
  const angle = randomGeneratorSlot.value.sample() * TWO_PI;
  return d__namespace.vec2f(std.cos(angle) * radius, std.sin(angle) * radius);
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({sqrt: std.sqrt, randomGeneratorSlot, TWO_PI, d: d__namespace, cos: std.cos, sin: std.sin}),
            }) && $.f)({}))), "randInUnitCircle"));
const randOnUnitCircle = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([], d__namespace.vec2f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = (() => {
  const angle = randomGeneratorSlot.value.sample() * TWO_PI;
  return d__namespace.vec2f(std.cos(angle), std.sin(angle));
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({randomGeneratorSlot, TWO_PI, d: d__namespace, cos: std.cos, sin: std.sin}),
            }) && $.f)({}))), "randOnUnitCircle"));
((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3f], d__namespace.vec3f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((v) => {
  let vNonZero = v;
  if (std.length(v) === 0) {
    vNonZero = v.add(EPS);
  }
  return std.normalize(vNonZero);
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({length: std.length, EPS, normalize: std.normalize}),
            }) && $.f)({}))), "safeNormalize"));
const randInUnitSphere = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([], d__namespace.vec3f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = (() => {
  const u = randomGeneratorSlot.value.sample();
  const v = d__namespace.vec3f(randNormal(0, 1), randNormal(0, 1), randNormal(0, 1));
  const vNorm = std.normalize(v);
  return vNorm.mul(std.pow(u, 0.33));
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({randomGeneratorSlot, d: d__namespace, randNormal, normalize: std.normalize, pow: std.pow}),
            }) && $.f)({}))), "randInUnitSphere"));
const randOnUnitSphere = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([], d__namespace.vec3f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = (() => {
  const z = 2 * randomGeneratorSlot.value.sample() - 1;
  const oneMinusZSq = std.sqrt(1 - z * z);
  const theta = TWO_PI * randomGeneratorSlot.value.sample();
  const x = std.cos(theta) * oneMinusZSq;
  const y = std.sin(theta) * oneMinusZSq;
  return d__namespace.vec3f(x, y, z);
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({randomGeneratorSlot, sqrt: std.sqrt, TWO_PI, cos: std.cos, sin: std.sin, d: d__namespace}),
            }) && $.f)({}))), "randOnUnitSphere"));
const randInUnitHemisphere = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3f], d__namespace.vec3f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((normal) => {
  const value = randInUnitSphere();
  const alignment = std.dot(normal, value);
  return std.mul(std.sign(alignment), value);
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({randInUnitSphere, dot: std.dot, mul: std.mul, sign: std.sign}),
            }) && $.f)({}))), "randInUnitHemisphere"));
const randOnUnitHemisphere = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3f], d__namespace.vec3f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((normal) => {
  ...
  return std.mul(std.sign(alignment), value);
              ...
              externals: () => ({randOnUnitSphere, dot: std.dot, mul: std.mul, sign: std.sign}),
            }) && $.f)({}))), "randOnUnitHemisphere"));
const randUniformExclusive = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([], d__namespace.f32)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = (() => {
...
const randNormal = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.f32, d__namespace.f32], d__namespace.f32)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((mu, sigma) => {
  const theta = TWO_PI * randUniformExclusive();
  const R = std.sqrt(-2 * std.log(randUniformExclusive()));
  return R * std.sin(theta) * sigma + mu;
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({TWO_PI, randUniformExclusive, sqrt: std.sqrt, log: std.log, sin: std.sin}),
            }) && $.f)({}))), "randNormal"));
const randExponential = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.f32], d__namespace.f32)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((rate) => {
  const u = randUniformExclusive();
  return -1 / rate * std.log(u);
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({randUniformExclusive, log: std.log}),
            }) && $.f)({}))), "randExponential"));
const randCauchy = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.f32, d__namespace.f32], d__namespace.f32)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((x0, gamma) => {
  const u = randUniformExclusive();
  return x0 + gamma * std.tan(Math.PI * (u - 0.5));
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({randUniformExclusive, tan: std.tan, Math}),
            }) && $.f)({}))), "randCauchy"));
const randBernoulli = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.f32], d__namespace.f32)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((p) => {
  const u = randomGeneratorSlot.value.sample();
  return std.step(u, p);
}), {
              v: 1,
              ...
              externals: () => ({randomGeneratorSlot, step: std.step}),
            }) && $.f)({}))), "randBernoulli"));

const quinticInterpolationImpl = (($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((t) => {
  "use gpu";
  return std.mul(std.mul(t, std.mul(t, t)), std.add(std.mul(t, std.sub(std.mul(t, 6), 15)), 10));
}), {
              v: 1,
              ...
              externals: () => ({mul: std.mul, add: std.add, sub: std.sub}),
            }) && $.f)({}));
const quinticInterpolation2 = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec2f], d__namespace.vec2f)(quinticInterpolationImpl), "quinticInterpolation2"));
const quinticInterpolation3 = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3f], d__namespace.vec3f)(quinticInterpolationImpl), "quinticInterpolation3"));
const quinticDerivativeImpl = (($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((t) => {
  "use gpu";
  return std.mul(std.mul(std.mul(30, t), t), std.add(std.mul(t, std.sub(t, 2)), 1));
}), {
              v: 1,
...
const quinticDerivative2 = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec2f], d__namespace.vec2f)(quinticDerivativeImpl), "quinticDerivative2"));
((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3f], d__namespace.vec3f)(quinticDerivativeImpl), "quinticDerivative3"));

const computeJunctionGradient$1 = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec2i], d__namespace.vec2f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((pos) => {
  randSeed2(std.mul(1e-3, d__namespace.vec2f(pos)));
  return randOnUnitCircle();
              ...
              externals: () => ({randSeed2, mul: std.mul, d: d__namespace, randOnUnitCircle}),
            }) && $.f)({}))), "computeJunctionGradient"));
const getJunctionGradientSlot$1 = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.slot(computeJunctionGradient$1), "getJunctionGradientSlot"));
const sample$1 = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec2f], d__namespace.f32)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((pos) => {
  const i = d__namespace.vec2i(std.floor(pos));
  const f = std.fract(pos);
  const u = quinticInterpolation2(f);
  const ga = getJunctionGradientSlot$1.$(i);
  const gb = getJunctionGradientSlot$1.$(std.add(i, d__namespace.vec2i(1, 0)));
  const gc = getJunctionGradientSlot$1.$(std.add(i, d__namespace.vec2i(0, 1)));
  const gd = getJunctionGradientSlot$1.$(std.add(i, d__namespace.vec2i(1, 1)));
  const va = std.dot(ga, std.sub(f, d__namespace.vec2f(0, 0)));
  const vb = std.dot(gb, std.sub(f, d__namespace.vec2f(1, 0)));
  const vc = std.dot(gc, std.sub(f, d__namespace.vec2f(0, 1)));
  const vd = std.dot(gd, std.sub(f, d__namespace.vec2f(1, 1)));
  ...
  return noise;
              ...
              externals: () => ({d: d__namespace, floor: std.floor, fract: std.fract, quinticInterpolation2, getJunctionGradientSlot: getJunctionGradientSlot$1, add: std.add, dot: std.dot, sub: std.sub}),
            }) && $.f)({}))), "sample"));
const sampleWithGradient = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec2f], d__namespace.vec3f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((pos) => {
  const i = d__namespace.vec2i(std.floor(pos));
  const f = std.fract(pos);
  const u = quinticInterpolation2(f);
  ...
  const grad = std.add(
    ...
    std.add(
      std.add(
        std.add(std.mul(u.x, std.sub(gb, ga)), std.mul(u.y, std.sub(gc, ga))),
        std.mul(u.x, std.mul(u.y, std.add(std.sub(std.sub(ga, gb), gc), gd)))
      ),
      std.mul(du, std.sub(std.add(std.mul(u.yx, va - vb - vc + vd), d__namespace.vec2f(vb, vc)), va))
    )
  );
  return d__namespace.vec3f(noise, grad);
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({d: d__namespace, floor: std.floor, fract: std.fract, quinticInterpolation2, quinticDerivative2, getJunctionGradientSlot: getJunctionGradientSlot$1, add: std.add, dot: std.dot, sub: std.sub, mul: std.mul}),
            }) && $.f)({}))), "sampleWithGradient"));

const MemorySchema$3 = d__namespace.arrayOf(d__namespace.vec2f);
...
function dynamicCacheConfig$1(options) {
  ...
  const valuesSlot = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.slot(), "valuesSlot"));
  const cleanValuesSlot = tgpu__default["~unstable"].derived(() => {
    return {
      get size() {
  ...
  const getJunctionGradient = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec2i], d__namespace.vec2f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((pos) => {
    const size = d__namespace.vec2i(cleanValuesSlot.value.size);
    ...
    return cleanValuesSlot.value.memory[x + y * size.x];
              ...
              externals: () => ({d: d__namespace, cleanValuesSlot}),
            }) && $.f)({}))), "getJunctionGradient"));
  const computeLayout = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.bindGroupLayout({
    size: { uniform: d__namespace.vec2u },
  ...
  const mainCompute = (($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((x, y) => {
    ...
    computeLayout.$.memory[idx] = computeJunctionGradient$1(
      d__namespace.vec2i(x, y)
              ...
              externals: () => ({computeLayout, computeJunctionGradient: computeJunctionGradient$1, d: d__namespace}),
            }) && $.f)({}));
  const instance = (root, initialSize) => {
    let dirty = false;
    let size = initialSize;
    const sizeBuffer = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(root.createBuffer(d__namespace.vec2u, size).$usage("uniform"), "sizeBuffer"));
    ...
    const createMemory = () => {
      const memory = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(root.createBuffer(d__namespace.arrayOf(d__namespace.vec2f, size.x * size.y)).$usage("storage"), "memory"));
  ...
  return {
    layout: {
      [`${prefix}size`]: { uniform: d__namespace.vec2u },
...
const MemorySchema$2 = d__namespace.arrayOf(d__namespace.vec2f);
function staticCache$1(options) {
  ...
  const computePipeline = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(root["~unstable"].createGuardedComputePipeline((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((x, y) => {
    "use gpu";
    const idx = x + y * size.x;
    memoryMutable.$[idx] = computeJunctionGradient$1(d__namespace.vec2i(x, y));
  }), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({size, memoryMutable, computeJunctionGradient: computeJunctionGradient$1, d: d__namespace}),
            }) && $.f)({}))), "computePipeline"));
  computePipeline.dispatchThreads(size.x, size.y);
  const getJunctionGradient = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec2i], d__namespace.vec2f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((pos) => {
    const size_i = d__namespace.vec2i(size);
    ...
    return memoryReadonly.$[x + y * size_i.x];
              ...
              externals: () => ({d: d__namespace, size, memoryReadonly}),
            }) && $.f)({}))), "getJunctionGradient"));
  return {
    getJunctionGradient,
    get size() {
...
const computeJunctionGradient = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3i], d__namespace.vec3f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((pos) => {
  randSeed3(std.mul(1e-3, d__namespace.vec3f(pos)));
  return randOnUnitSphere();
              ...
              externals: () => ({randSeed3, mul: std.mul, d: d__namespace, randOnUnitSphere}),
            }) && $.f)({}))), "computeJunctionGradient"));
const getJunctionGradientSlot = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.slot(computeJunctionGradient), "getJunctionGradientSlot"));
const dotProdGrid = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3f, d__namespace.vec3f], d__namespace.f32)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((pos, junction) => {
  const relative = std.sub(pos, junction);
  const gridVector = getJunctionGradientSlot.value(d__namespace.vec3i(junction));
  return std.dot(relative, gridVector);
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({sub: std.sub, getJunctionGradientSlot, d: d__namespace, dot: std.dot}),
            }) && $.f)({}))), "dotProdGrid"));
const sample = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3f], d__namespace.f32)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((pos) => {
  const minJunction = std.floor(pos);
  const xyz = dotProdGrid(pos, minJunction);
  const xyZ = dotProdGrid(pos, std.add(minJunction, d__namespace.vec3f(0, 0, 1)));
  const xYz = dotProdGrid(pos, std.add(minJunction, d__namespace.vec3f(0, 1, 0)));
  const xYZ = dotProdGrid(pos, std.add(minJunction, d__namespace.vec3f(0, 1, 1)));
  const Xyz = dotProdGrid(pos, std.add(minJunction, d__namespace.vec3f(1, 0, 0)));
  const XyZ = dotProdGrid(pos, std.add(minJunction, d__namespace.vec3f(1, 0, 1)));
  const XYz = dotProdGrid(pos, std.add(minJunction, d__namespace.vec3f(1, 1, 0)));
  const XYZ = dotProdGrid(pos, std.add(minJunction, d__namespace.vec3f(1, 1, 1)));
  const partial = std.sub(pos, minJunction);
  const smoothPartial = quinticInterpolation3(partial);
  const xy = std.mix(xyz, xyZ, smoothPartial.z);
  const xY = std.mix(xYz, xYZ, smoothPartial.z);
  const Xy = std.mix(Xyz, XyZ, smoothPartial.z);
  const XY = std.mix(XYz, XYZ, smoothPartial.z);
  const x = std.mix(xy, xY, smoothPartial.y);
  const X = std.mix(Xy, XY, smoothPartial.y);
  return std.mix(x, X, smoothPartial.x);
}), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({floor: std.floor, dotProdGrid, add: std.add, d: d__namespace, sub: std.sub, quinticInterpolation3, mix: std.mix}),
            }) && $.f)({}))), "sample"));

const MemorySchema$1 = d__namespace.arrayOf(d__namespace.vec3f);
...
function dynamicCacheConfig(options) {
  ...
  const getJunctionGradient = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3i], d__namespace.vec3f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((pos) => {
    const size = d__namespace.vec3i(cleanValuesSlot.$.size.xyz);
    const x = (pos.x % size.x + size.x) % size.x;
    const y = (pos.y % size.y + size.y) % size.y;
  ...
  const computeLayout = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.bindGroupLayout({
    size: { uniform: d__namespace.vec4u },
  ...
  const mainCompute = (($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((x, y, z) => {
    ...
    computeLayout.$.memory[idx] = computeJunctionGradient(d__namespace.vec3i(x, y, z));
  }), {
              v: 1,
              name: "mainCompute",
              ...
              externals: () => ({computeLayout, computeJunctionGradient, d: d__namespace}),
            }) && $.f)({}));
  const instance = (root, initialSize) => {
    let dirty = false;
    let size = d__namespace.vec4u(initialSize, 0);
    const sizeBuffer = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(root.createBuffer(d__namespace.vec4u, size).$usage("uniform"), "sizeBuffer"));
    const computePipeline = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(root["~unstable"].createGuardedComputePipeline(mainCompute), "computePipeline"));
    const createMemory = () => {
      const memory = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(root.createBuffer(d__namespace.arrayOf(d__namespace.vec3f, size.x * size.y * size.z)).$usage("storage"), "memory"));
      const computeBindGroup = root.createBindGroup(computeLayout, {
        size: sizeBuffer,
        memory
      });
    ...
    return {
      ...
      set size(_value) {
        const value = d__namespace.vec4u(_value, 0);
        if (std.allEq(size, value)) {
          return;
        }
        size = value;
  ...
  return {
    layout: {
      [`${prefix}size`]: { uniform: d__namespace.vec4u },
...
const MemorySchema = d__namespace.arrayOf(d__namespace.vec3f);
function staticCache(options) {
  ...
  const computePipeline = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(root["~unstable"].createGuardedComputePipeline((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((x, y, z) => {
    "use gpu";
    const idx = x + y * size.x + z * size.x * size.y;
    memoryMutable.$[idx] = computeJunctionGradient(d__namespace.vec3i(x, y, z));
  }), {
              v: 1,
              name: undefined,
              ...
              externals: () => ({size, memoryMutable, computeJunctionGradient, d: d__namespace}),
            }) && $.f)({}))), "computePipeline"));
  computePipeline.dispatchThreads(size.x, size.y, size.z);
  const getJunctionGradient = ((globalThis.__TYPEGPU_AUTONAME__ ?? (a => a))(tgpu__default.fn([d__namespace.vec3i], d__namespace.vec3f)((($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((pos) => {
    const size_i = d__namespace.vec3i(size);
    const x = (pos.x % size_i.x + size_i.x) % size_i.x;
    const y = (pos.y % size_i.y + size_i.y) % size_i.y;
...
exports.BPETER = BPETER;
exports.DefaultGenerator = DefaultGenerator;
exports.perlin2d = index$1;
exports.perlin3d = index;
exports.randf = randf;
exports.randomGeneratorShell = randomGeneratorShell;
exports.randomGeneratorSlot = randomGeneratorSlot;
